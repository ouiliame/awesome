...
- [Terra](https://github.com/terra-project/awesome-terra#readme) - Open source blockchain platform with infrastructure for developing new financial primitives for a decentralized economy.
